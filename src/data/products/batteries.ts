...
**Authorized Dealer: Al-Qatta Establishment**`,
    ...
    useCases: [
      ...
      },
      {
        ...
        titleEn: 'Apartments',
        descAr: 'توفير المساحة مع التركيب الجداري',
        descEn: 'Space saving with wall mount installation',
        icon: 'Building',
      },
      {
        titleAr: 'المكاتب',
        titleEn: 'Offices',
        descAr: 'طاقة احتياطية موثوقة لأجهزة الكمبيوتر والاتصالات',
        descEn: 'Reliable backup power for computers and communications',
        icon: 'Briefcase',
      },
    ],
...
Light and powerful - ideal for camping, road trips, and power outages.`,
    ...
    specifications: [
      ...
      { keyAr: 'مخارج AC', keyEn: 'AC Outputs', value: '2 (مقبوضة بالمواصفات)' },
